        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://facebook.com/kraftagency" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 hover:bg-white/10 rounded-lg flex items-center justify-center transition" aria-label="Facebook">
              ...
              <a href="https://linkedin.com/company/kraftagency" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 hover:bg-white/10 rounded-lg flex items-center justify-center transition" aria-label="LinkedIn">
